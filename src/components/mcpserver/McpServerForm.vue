  ...
  <div class="mcpserver-form">
    ...
    >
      <n-grid :cols="24" :x-gap="24">
        <n-form-item-gi :span="12" :label="t('mcpserver.server_name')" path="name">
          <n-input
        ...
        <n-form-item-gi :span="12" :label="t('namespace.namespace')" path="namespace">
        ...
        <n-form-item-gi :span="24" :label="t('mcpserver.server_description')" path="description">
          <n-input
        ...
        <n-form-item-gi :span="24" :label="t('mcpserver.auth_keys')" path="authKeys">
          <n-dynamic-input
