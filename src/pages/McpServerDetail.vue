  ...
  <div class="mcpserver-detail-page">
    ...
    <div class="page-header">
      <n-space align="center">
        ...
        <n-tag v-if="isEditMode" type="warning">{{
      ...
      <n-space v-else>
        ...
        <n-button type="primary" :loading="submitting" @click="saveChanges">
          <template #icon>
      ...
      <div v-if="serverData" class="page-content">
        ...
        <n-card :title="t('mcpserver.tool_info')" class="info-card">
          <div v-if="!isEditMode">
            <n-spin
              :show="toolsLoading"
              :description="t('mcpserver.loading_tools')"
            >
                      ...
                      >
                        <div v-if="tool.routeRule" class="route-rule-display">
                          <n-space align="center" :wrap="false">
                            <n-tag
                              :type="
                                getRouteRuleTagType(tool.routeRule.ruleType)
                              "
                              size="small"
                            >
                            ...
                            <n-popover
                              v-if="
                                tool.routeRule.config &&
                                Object.keys(tool.routeRule.config).length > 0
                              "
                              :width="300"
                              trigger="hover"
                            >
                              ...
                              <n-code
                                :code="
                                  formatRouteRuleConfig(tool.routeRule.config)
                                "
                                language="json"
                                :word-wrap="true"
                              />
              ...
              <div v-else class="empty-state">
                <n-empty :description="t('mcpserver.no_tools')" size="large">
                  <template #extra>
                    <n-button
