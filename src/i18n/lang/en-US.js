...
const message = {
	...
	role:{
	 ...
	 "monitor":{
		...
		"http_request_handle_rt_summary_percent_ms": "http request avg handle time percent(ms)",
		"grpc_request_handle_rt_summary": "grpc request avg handle time",
		"grpc_request_handle_rt_summary_percent_ms": "grpc request avg handle time percent(ms)",
		"LEAST":"LEAST",
		"MINUTE":"MINUTE",
		"HOUR":"HOUR",
